...
Module.register('MMM-AlarmClock', {
    ...
    /** 
     * All code beyond this point was added by Axelle Jamous 
     * Student Electronics & ICT @ AP University College Antwerp 
     */
    ...
    notificationReceived: function(notification, payload, sender) {
        ...
        if(notification === "SET_ALARM"){
            ...
            this.config.alarms.push({time: mqttData.hour+":"+mqttData.min, days: [0,1,2,3,4,5,6], sound: "alarm.mp3", title: "Alarm", message: mqttData.msg});
